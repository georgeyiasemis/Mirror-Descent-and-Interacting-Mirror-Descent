...
path_sgd = "./saved_items/Nsamp_100/{'N' 100, 'D' 3, 'K' 10, 'lambd' 2, 'var' 1, 'cluster_std' 1.5, 'cluster_random_state' 10, 'sigma' 0, 'lr' 0.0005, 'eps' 1, 'max_iters' 100, 'Niid' 1, 'decreasing_lr' True, 'seed' 1}"
path_smd = "./saved_items/Nsamp_100/{'N' 100, 'D' 3, 'K' 10, 'lambd' 2, 'var' 1, 'cluster_std' 1.5, 'cluster_random_state' 10, 'sigma' 0, 'lr' 0.2, 'eps' 1, 'max_iters' 100, 'Niid' 1, 'decreasing_lr' True, 'seed' 1}"
# path_smd = "./saved_items/MD_Niid_2_iters_100_s_1"
path_imd = "./saved_items/Nsamp_100/{'N' 100, 'D' 3, 'K' 10, 'lambd' 2, 'var' 1, 'cluster_std' 1.5, 'cluster_random_state' 10, 'sigma' 0, 'lr' 0.2, 'eps' 1, 'max_iters' 100, 'num_particles' 2, 'decreasing_lr' True, 'seed' 1}"
...
plt.plot(np.array(smd_losses)[:],linewidth=1, label='MD')
plt.plot(np.array(sgd_losses)[:],linewidth=1, label='GD')
plt.plot(np.array(imd_losses)[:],linewidth=1, label='IMD')
